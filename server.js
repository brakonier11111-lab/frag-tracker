...
// getDonatePayLastEventsSimple, getDonatePayLastEvents, getDonatePayWidgetDonations —
// удалены как мёртвый код (0 вызовов в репозитории, устаревшие HTML-виджет-парсеры,
// заменены на getDonatePayNewTransactions + Centrifugo)
...
// getDonatePayDonations удалена как мёртвый код (0 вызовов, была явно отключена)
