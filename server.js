...
// API для чата (messages/stats) вынесен в src/modules/chat-stats

// Ручной выбор текущего стрима YouTube по videoId/URL
// /integrations/youtube/video-id, /poll-interval, /find-live,
// detectActiveYouTubeLive, /oauth/youtube/start и /callback
// вынесены в src/modules/youtube-integration
...
// collectYouTubeChat/updateYouTubeData вынесены в src/modules/youtube-integration
...
// YouTube polling (setInterval) вынесен в src/modules/youtube-integration (youtube.startPolling())
